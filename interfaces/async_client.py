...
def exchange(client_port, server_port, im_path, conf_thres=0.6, nms=0.5, eps_m=2, eps_o= 0, eps_samples=3):
...
if __name__ == "__main__":
    ...
    image_path = "D:\Projects\VSTech\yolov5\outputs\data_new_view\original_images\\29062022_295.jpg"
    result_dict = exchange(client_addr, server_addr, image_path, conf_thres=0.6, nms=0.5, eps_m=2, eps_o= 0, eps_samples=3)
...
#     output_path = "D:\Projects\VSTech\yolov5\outputs\output_2704_20epoch_freeze_23\\all_retrained_2\\errors_yolov5n6"
